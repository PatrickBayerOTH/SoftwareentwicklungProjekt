                    ...
                    <form:form class="form-row" modelAttribute="sendForm" action="${selectUrl}">
                        ...
                        <spring:bind path="amount">
                            <div class="form-group col-sm-8  ${status.error ? 'has-error' : ''}">
                                <form:input path="amount" type="text" class="form-control" id="amount" required="required" />
    ...
    <c:if test="${targetfriend eq 'targetfriend'}">
        <div class="overflow-hidden p-3 p-md-5 m-md-3 bg-light">
            ...
            <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
                ...
                <button onclick="location.href='http://localhost:8080/removeFriend/${friend.friendId}'" type="button" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-cash-coin" viewBox="0 0 16 16">
