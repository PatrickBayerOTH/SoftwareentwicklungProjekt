...
<head>
    ...
    <title><spring:message code="logout.title"></spring:message></title>
...
<p class="alert alert-dark" role="alert">
    <spring:message code="logout.head"></spring:message>
</p>
<br>
<div>
    <a href="/login" class="btn btn-outline-warning ui-state-active" type="button"
       role="button"><spring:message code="logout.btn"></spring:message></a>
</div>
