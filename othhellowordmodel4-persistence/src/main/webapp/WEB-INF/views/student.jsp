...
<head>
    ...
    <title><spring:message code="student.title"></spring:message></title>
...
<header>
    ...
    <div class="alert alert-success" role="alert">
        <h4 class="mt-1 mb-2 pb-1"><spring:message code="student.head"></spring:message> - ${studentSession.user.name} ${studentSession.user.nachname} </h4>
    </div>
    <br>
    <h4 class="mt-1 mb-5 pb-1">
        <spring:message code="student.welcome"></spring:message>, ${studentSession.user.name}!
    </h4>
    <div>
        <a href="/user/accountVerwalten/${studentSession.user.id}" class="btn btn-outline-primary ui-state-active" type="button" role="button"><spring:message code="student.btn"></spring:message></a>
    </div>
    <br>
</body>
